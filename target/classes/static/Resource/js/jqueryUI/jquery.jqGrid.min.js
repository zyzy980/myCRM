...
(function(b) {
    ...
    b.fn.jqGrid = function(f) {
    	...
    	if(arguments.length >= 2 && arguments[0] == "setGridParam" ){
    		
    		if(typeof arguments[1].postData == "function"){
        		//注:如果请求前绑定了参数，次获取同一方法数据就多此一举了,待处理
        		if(this.length && !this[0].p.beforeRequestBind){
        			var gridObj = this[0].p;
        			gridObj.beforeRequestBind = true;
                	var old_beforeRequest = gridObj.beforeRequest || function(){}; 
                	var old_requestParam2 = arguments[1].postData;
                	gridObj.beforeRequest = function(a){
                		var obj = old_requestParam2();
                		old_beforeRequest.call(this, arguments);
                		return obj;
                	}
        		}
        		arguments[1].postData = {};
        ...
        //公共显示条数设置
        if (typeof f == "object") {
        	f.onCellSelect = function(rowid,iCol,cellcontent,e){
	    	   checkboxJqgrid(rowid, iCol, cellcontent, e,this);
	        };
	        
            var rowNumList = window.top.cacheTemp_rowNum || [];
            if ((f.rowNum > 1 || f.rowNum == null) && f.rowList != null) {
                f.rowList = rowNumList || [50];
                if (f.rowNum <= rowNumList[0]) {
                    f.rowNum = rowNumList[0];
                }
            }
            
            //beforeRequest
            if(typeof f.postData=="function"){
            	f.beforeRequestBind = true;
            	var old_beforeRequest = f.beforeRequest || function(){}; 
            	var old_requestParam = f.postData;
            	f.beforeRequest = function(a){
            		var obj = old_requestParam();
            		old_beforeRequest.call(this, arguments);
            		return obj;
            	}
            	f.postData = {};
            ...
            if(f.colModel){
            	//自定义日期格式
            	for(var i = 0;i < f.colModel.length; i++){
            		var obj = f.colModel[i];
            		if(typeof obj.type == "string" && obj.type.toUpperCase() == "DATE"){
            			if(obj.searchoptions && window.WdatePicker){
            				obj.type = "string";
            				obj.index = "_d_"+obj.index;
            				obj.searchoptions.dataEvents = [ {
            					type : 'click',
            					data : {},
            					fn : function() {
            						WdatePicker();
      ...
      //postData属性 filters不允许修改
    	if(f== "setGridParam"){
    		if(typeof arguments[1] == "object"){
    			if(arguments[1].postData){
    				if($.trim(arguments[1].postData.filters) == ""){
    					delete arguments[1].postData.filters;
    				}
    			}
    		}
    	}
                ...
                if (this.tagName != "TABLE") alert("Element is not a table");
                    ...
                    if (this.p.colNames.length !== this.p.colModel.length) alert(b.jgrid.errors.model);
                        ...
                        $ = function(d) {
                            ...
                            if (!g || !g.length) g = b.map(a.p.colModel,
                            function(h, o) {
                                return o
                            });
                            if (d) g = b.map(g,
                        ...
                        L = function(d, g, h, o, p) {
                            ...
                            if (d) {
                                ...
                                a.p.totaltime = new Date - x;
                                if (s > 0) if (a.p.records === 0) a.p.records = W;
                                if (!a.p.treeGrid && !a.p.scroll) a.grid.bDiv.scrollTop = 0;
                                a.p.reccount = s;
                                a.p.treeANode = -1;
                                a.p.userDataOnFooter && b(a).jqGrid("footerData", "set", a.p.userData, true);
                        ...
                        oa = function() {
                            ...
                            if (window.navigator.userAgent.indexOf("Chrome") == -1) {
                                b(".ui-jqgrid-bdiv").css("padding-bottom", "0.1px");
                                setTimeout(function() {
                                    b(".ui-jqgrid-bdiv").css("padding-bottom", "0px");
                                },
                                200);
                            }
                        },
                            ...
                            if (!a.grid.hDiv.loading) {
                                ...
                                if (b.isFunction(a.p.datatype)) a.p.datatype.call(a, a.p.postData, "load_" + a.p.id);
                                    ...
                                    if (b.isFunction(a.p.beforeRequest)){
                                    	temp_v = a.p.beforeRequest.call(a);
                                    } 
                                    if(typeof a.p.postData == "object" && temp_v){
                            			for (v in temp_v){
                            				a.p.postData[v] = temp_v[v];
                            			}
                                    }
                            ...
                            function() {
                                if (this.checked) {
                                    ...
                                    b(a.rows).each(function(d) {
                                        if (d > 0) if (!b(this).hasClass("subgrid") && !b(this).hasClass("jqgroup") && !b(this).hasClass("jqfoot")) {
                        ...
                        if (F) {
                            ...
                            a.p.multikey && b(e.bDiv).bind("selectstart",
                            function() {
                                return false
                            })
                        } else a.p.multikey && b(e.bDiv).bind("mousedown",
                        function() {
                            return false
                        });
                        ba && b(e.bDiv).hide();
                        ...
                        if (a.p.caption) {
                            ...
                            if (a.p.hidegrid === true) {
                                b(".ui-jqgrid-titlebar-close", e.cDiv).click(function(d) {
                                    ...
                                    if (a.p.gridstate == "visible") b(h, "#gbox_" + a.p.id).slideUp("fast",
                                    function() {
                                        o--;
                                        if (o == 0) {
                                    ...
                                    else a.p.gridstate == "hidden" && b(h, "#gbox_" + a.p.id).slideDown("fast",
                                    function() {
                                        o--;
                                        if (o == 0) {
        ...
        setSelection: function(f, j) {
            return this.each(function() {
                function i(n) {
                    ...
                    else if (t < a + r) if (t < r) b(c.grid.bDiv)[0].scrollTop = t
                }
                var c = this,
                e, k;
                if (f !== undefined) {
    ...
    c.fn.fmatter.select = function(a, b) {
        ...
        if (d) {
            ...
            } else if (c.fmatter.isObject(d)) if (e) f = jQuery.map(i,
            function(l) {
                return d[l]
            });
            else f[0] = d[a] || ""
    ...
    c.fn.fmatter.rowactions = function(a, b, d, f) {
        ...
        c.fmatter.isUndefined(f.formatoptions) || (e = c.extend(e, f.formatoptions));
        f = function(g) {
    ...
    a.jgrid.extend({
        ...
        setColProp: function(f, d) {
            return this.each(function() {
                if (this.grid) if (d) for (var b = this.p.colModel,
                m = 0; m < b.length; m++) if (b[m].name == f) {
            ...
            return this.each(function() {
                ...
                if (this.p.filterModel.length === 0 && this.p.gridModel === false) alert("No filter is set");
                    ...
                    if (m) {
                        ...
                        o,
                        c = a("<form name='SearchForm' style=display:inline;' class='" + this.p.formclass + "'></form>");
                        o = a("<table class='" + this.p.tableclass + "' cellspacing='0' cellpading='0' border='0'><tbody></tbody></table>");
                        a(c).append(o); (function() {
    ...
    a.jgrid.extend({
        ...
        editGridRow: function(e, b) {
            ...
            return this.each(function() {
                function p() {
                    a(".FormElement", "#" + j).each(function() {
                        ...
                        if (g.length) {
                            ...
                            case "checkbox":
                                if (a(this).attr("checked")) f[this.name] = a(this).val();
                                else {
                            ...
                            if (d.p.autoencode) f[this.name] = a.jgrid.htmlEncode(f[this.name])
                        }
                    });
                    return true
                }
                function F(g, n, x, s) {
                    for (var G, B, C, L = 0,
                    A, M, D, S = [], H = false, aa = "", Q = 1; Q <= s; Q++) aa += "<td class='CaptionTD'>&#160;</td><td class='DataTD'>&#160;</td>";
                    ...
                    a(n.p.colModel).each(function(U) {
                        ...
                        if (G !== "cb" && G !== "subgrid" && this.editable === true && G !== "rn") {
                            ...
                            if (X.rowabove) {
                                W = a("<tr><td class='contentinfo' colspan='" + s * 2 + "'>" + X.rowcontent + "</td></tr>");
                                a(x).append(W);
                                W[0].rp = ba
                            }
                            if (C.length === 0) {
                ...
                function z() {
                    ...
                    if (n[0] && !c.processing) {
                        ...
                        if (f[B] != s.addoper) f[G] = f[d.p.id + "_id"];
    ...
    function I(e, l, v) {
        ...
        if (l != null) {
            ...
            e.find(".ui-search").click(function() {
                ...
                b,
                d = a.find("select[name='groupOp'] :selected").val();
...
jQuery.fn.searchFilter.defaults = {
    ...
    n = function(a) {
        var f = i[k[k.length - 1]]; (a = !b(a.target).parents(".jqmID" + f.s)[0]) && s(f);
        return ! a
    },
    o = function(a, f, c) {
            ...
            return this.each(function() {
                ...
                if (a.grid) {
                    ...
                    x = function(g) {
                        ...
                        if (a.p.subGridModel[0].params) for (h = 0; h < a.p.subGridModel[0].params.length; h++) for (d = 0; d < a.p.colModel.length; d++) if (a.p.colModel[d].name == a.p.subGridModel[0].params[h]) f[a.p.colModel[d].name] = b("td:eq(" + d + ")", g).text().replace(/\&#160\;/ig, "");
                        if (!a.grid.hDiv.loading) {
                            a.grid.hDiv.loading = true;
                            b("#load_" + a.p.id).show();
    ...
    f.jgrid.extend({
            ...
            return this.each(function() {
                ...
                if (b !== null && (typeof b === "object" || f.isFunction(b))) if (b.groupField.length) {
                    for (var a = 0; a < b.groupField.length; a++) {
                        ...
                        if (b.groupSummary[a]) {
                            b.summary[a] = [];
                            for (var d = c.p.colModel,
                            e = 0,
                            g = d.length; e < g; e++) d[e].summaryType && b.summary[a].push({
                                nm: d[e].name,
                                st: d[e].summaryType,
                                v: ""
                            })
        ...
        groupingPrepare: function(c, b, a, d) {
            this.each(function() {
                ...
                g.groupSummary[0] && f.each(g.summaryval[0][e],
                function() {
            ...
            return this.each(function() {
                ...
                function(h, l) {
                    ...
                    if (d.groupSummary[0]) {
                        ...
                        h = d.summaryval[0][l];
                        for (var o = a.p.colModel,
                        p, r = c[l].length, i = 0; i < b; i++) {
        ...
        setTreeNode: function(b, c) {
            return this.each(function() {
                ...
                if (a.grid && a.p.treeGrid) {
                    ...
                    a.p.ExpandColClick === true && d("span", c).css("cursor", "pointer").bind("click",
                    function(h) {
                        h = d(h.target || h.srcElement, a.rows).closest("tr.jqgrow")[0].id;
                        var m = a.p._index[h],
                                    ...
                                    drop: function(e, g) {
                                        if (a(g.draggable).hasClass("jqgrow")) {
                                            ...
                                            if (d.beforedrop && a.isFunction(d.beforedrop)) {
                                                n = d.beforedrop.call(this, e, g, i, a("#" + c.id), a(this));
