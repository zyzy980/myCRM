 ...
 */
@RestController
@RequestMapping("/Ht_CusController")
public class Ht_CusController {
    ...
    @Log(value = "合同管理-对上正式合同-下载导入明细模板")
